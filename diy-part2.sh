...
rm -rf feeds/{luci,packages}/{applications,lang,net}/{luci-app-openclash,luci-app-passwall,golang,luci-app-openclash,luci-app-passwall,golang,chinadns-ng,daed,dns2socks,dns2tcp,geoview,hysteria,ipt2socks,microsocks,mosdns,naiveproxy,pdnsd,redsocks2,simple-obfs,sing-box,tcping,trojan-plus,trojan,tuic-client,v2ray-core,v2ray-geodata,v2ray-plugin,xray-core,xray-plugin}
