...
sed -i '2i src-git momo https://github.com/nikkinikki-org/OpenWrt-momo.git;main' feeds.conf.default
sed -i '3i src-git mosdns https://github.com/sbwml/luci-app-mosdns.git;v5' feeds.conf.default
